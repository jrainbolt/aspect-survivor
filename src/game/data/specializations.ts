import type { PaladinSpecializationId, SpecializationSummary } from '../types';

export interface SpecializationDefinition extends SpecializationSummary {
  id: PaladinSpecializationId;
  characterId: 'paladin';
...
export const specializationDefinitions: Record<PaladinSpecializationId, SpecializationDefinition> = {
  crusader: {
    id: 'crusader', characterId: 'paladin', displayName: 'Crusader', weaponName: 'Crusader Blade',
    description: 'An aggressive holy warrior who overwhelms foes with broad, rapid cuts.',
    pros: ['Broad multi-target cuts', 'Fast sword cadence'], cons: ['Weaker defensive scaling'], startingBonus: 'Crusader Blade I',
  ...
  templar: {
    id: 'templar', characterId: 'paladin', displayName: 'Templar', weaponName: 'Templar Shield',
    description: 'A steadfast protector built around armor, control, and crushing shield impacts.',
    pros: ['Highest armor', 'Powerful shield control'], cons: ['Shortest sword reach'], startingBonus: 'Templar Shield I',
  ...
  guardian: {
    id: 'guardian', characterId: 'paladin', displayName: 'Guardian', weaponName: 'Guardian Pike',
    description: 'A reach fighter who holds lanes with long, piercing thrusts.',
    pros: ['Longest melee reach', 'Piercing thrust attacks'], cons: ['Slower attack cadence'], startingBonus: 'Piercing Pike I',
